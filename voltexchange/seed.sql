...
--    • 1 000 OfertasVenda
--
--  Executa DEPOIS de ddl.sql.
--  Tempo estimado: 30–90 s no servidor da escola.
-- ============================================================
...
VALUES
  ('Alice Ferreira',   'alice@voltex.pt',   '$2b$12$AAAAAAAAAAAAAAAAAAAAAA.seed_hash_alice',   1500.00),
  ('Bruno Costa',      'bruno@voltex.pt',   '$2b$12$BBBBBBBBBBBBBBBBBBBBBB.seed_hash_bruno',    800.50),
  ('Carla Mendes',     'carla@voltex.pt',   '$2b$12$CCCCCCCCCCCCCCCCCCCCCC.seed_hash_carla',   2200.75),
  ('David Sousa',      'david@voltex.pt',   '$2b$12$DDDDDDDDDDDDDDDDDDDDDD.seed_hash_david',    350.00),
  ('Eva Rodrigues',    'eva@voltex.pt',     '$2b$12$EEEEEEEEEEEEEEEEEEEEEE.seed_hash_eva',     5000.00),
  ('Filipe Neves',     'filipe@voltex.pt',  '$2b$12$FFFFFFFFFFFFFFFFFFFFFF.seed_hash_filipe',   120.25),
  ('Graça Lima',       'graca@voltex.pt',   '$2b$12$GGGGGGGGGGGGGGGGGGGGGG.seed_hash_graca',   3300.00),
  ('Hugo Pinto',       'hugo@voltex.pt',    '$2b$12$HHHHHHHHHHHHHHHHHHHHHH.seed_hash_hugo',     675.80),
  ('Inês Carvalho',    'ines@voltex.pt',    '$2b$12$IIIIIIIIIIIIIIIIIIIIII.seed_hash_ines',    1100.00),
  ('João Oliveira',    'joao@voltex.pt',    '$2b$12$JJJJJJJJJJJJJJJJJJJJJJ.seed_hash_joao',  9999.99);
...
--    Estados: 80 % ATIVA, 15 % VENDIDA, 5 % CANCELADA
-- ------------------------------------------------------------
