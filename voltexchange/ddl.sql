...
-- ------------------------------------------------------------
-- 0. Schema próprio + limpeza (ordem inversa de dependências)
--    Substitui 'voltexchange' pelo nome do teu utilizador/schema
--    caso o docente já tenha criado um schema para o grupo.
-- ------------------------------------------------------------
