...
CREATE SCHEMA IF NOT EXISTS voltexchange;
...
CREATE TABLE Contadores (
    ...
    Estado VARCHAR(20) NOT NULL DEFAULT 'ATIVO' CHECK (
        Estado IN ('ATIVO', 'MANUTENCAO')
    )
);
...
CREATE TABLE Leituras_2024_01 PARTITION OF Leituras FOR
VALUES
FROM ('2024-01-01') TO ('2024-02-01');

CREATE TABLE Leituras_2024_02 PARTITION OF Leituras FOR
VALUES
FROM ('2024-02-01') TO ('2024-03-01');

CREATE TABLE Leituras_2024_03 PARTITION OF Leituras FOR
VALUES
FROM ('2024-03-01') TO ('2024-04-01');

CREATE TABLE Leituras_2024_04 PARTITION OF Leituras FOR
VALUES
FROM ('2024-04-01') TO ('2024-05-01');

CREATE TABLE Leituras_2024_05 PARTITION OF Leituras FOR
VALUES
FROM ('2024-05-01') TO ('2024-06-01');

CREATE TABLE Leituras_2024_06 PARTITION OF Leituras FOR
VALUES
FROM ('2024-06-01') TO ('2024-07-01');

CREATE TABLE Leituras_2024_07 PARTITION OF Leituras FOR
VALUES
FROM ('2024-07-01') TO ('2024-08-01');

CREATE TABLE Leituras_2024_08 PARTITION OF Leituras FOR
VALUES
FROM ('2024-08-01') TO ('2024-09-01');

CREATE TABLE Leituras_2024_09 PARTITION OF Leituras FOR
VALUES
FROM ('2024-09-01') TO ('2024-10-01');

CREATE TABLE Leituras_2024_10 PARTITION OF Leituras FOR
VALUES
FROM ('2024-10-01') TO ('2024-11-01');

CREATE TABLE Leituras_2024_11 PARTITION OF Leituras FOR
VALUES
FROM ('2024-11-01') TO ('2024-12-01');

CREATE TABLE Leituras_2024_12 PARTITION OF Leituras FOR
VALUES
FROM ('2024-12-01') TO ('2025-01-01');

CREATE TABLE Leituras_2025_01 PARTITION OF Leituras FOR
VALUES
FROM ('2025-01-01') TO ('2025-02-01');

CREATE TABLE Leituras_2025_02 PARTITION OF Leituras FOR
VALUES
FROM ('2025-02-01') TO ('2025-03-01');

CREATE TABLE Leituras_2025_03 PARTITION OF Leituras FOR
VALUES
FROM ('2025-03-01') TO ('2025-04-01');

CREATE TABLE Leituras_2025_04 PARTITION OF Leituras FOR
VALUES
FROM ('2025-04-01') TO ('2025-05-01');

CREATE TABLE Leituras_2025_05 PARTITION OF Leituras FOR
VALUES
FROM ('2025-05-01') TO ('2025-06-01');

CREATE TABLE Leituras_2025_06 PARTITION OF Leituras FOR
VALUES
FROM ('2025-06-01') TO ('2025-07-01');

CREATE TABLE Leituras_2025_07 PARTITION OF Leituras FOR
VALUES
FROM ('2025-07-01') TO ('2025-08-01');

CREATE TABLE Leituras_2025_08 PARTITION OF Leituras FOR
VALUES
FROM ('2025-08-01') TO ('2025-09-01');

CREATE TABLE Leituras_2025_09 PARTITION OF Leituras FOR
VALUES
FROM ('2025-09-01') TO ('2025-10-01');

CREATE TABLE Leituras_2025_10 PARTITION OF Leituras FOR
VALUES
FROM ('2025-10-01') TO ('2025-11-01');

CREATE TABLE Leituras_2025_11 PARTITION OF Leituras FOR
VALUES
FROM ('2025-11-01') TO ('2025-12-01');

CREATE TABLE Leituras_2025_12 PARTITION OF Leituras FOR
VALUES
FROM ('2025-12-01') TO ('2026-01-01');

CREATE TABLE Leituras_2026_01 PARTITION OF Leituras FOR
VALUES
FROM ('2026-01-01') TO ('2026-02-01');

CREATE TABLE Leituras_2026_02 PARTITION OF Leituras FOR
VALUES
FROM ('2026-02-01') TO ('2026-03-01');

CREATE TABLE Leituras_2026_03 PARTITION OF Leituras FOR
VALUES
FROM ('2026-03-01') TO ('2026-04-01');

CREATE TABLE Leituras_2026_04 PARTITION OF Leituras FOR
VALUES
FROM ('2026-04-01') TO ('2026-05-01');

-- Partição "catch-all" para datas futuras não cobertas acima
CREATE TABLE Leituras_futuras PARTITION OF Leituras FOR
VALUES
FROM ('2026-05-01') TO ('2100-01-01');

-- Índice GIN no campo JSONB (pesquisas de anomalias)
CREATE INDEX idx_leituras_dadosaudit_gin ON Leituras USING GIN (DadosAudit);

-- Índice B-tree no ContadorID para JOINs rápidos
CREATE INDEX idx_leituras_contador ON Leituras (ContadorID);
...
CREATE TABLE OfertasVenda (
    ...
    Estado VARCHAR(20) NOT NULL DEFAULT 'ATIVA' CHECK (
        Estado IN (
            'ATIVA',
            'VENDIDA',
            'CANCELADA'
...
CREATE INDEX idx_ofertas_preco ON OfertasVenda (PrecoUnitario)
WHERE
    Estado = 'ATIVA';
...
CREATE TABLE OrdensCompra (
    ...
    Estado VARCHAR(20) NOT NULL DEFAULT 'PENDENTE' CHECK (
        Estado IN ('PENDENTE', 'CONCLUIDA')
    ),
    DataCriacao TIMESTAMP NOT NULL DEFAULT NOW()
);
